...
if(isset($_POST["mail"]))
{
	...
	$sql = "SELECT m.Email FROM t_mail m, trainer t WHERE m.TrainerID = t.TrainerID AND t.Username = '$uname'";
	$result = mysqli_query($conn,$sql);
	
	if($row=mysqli_fetch_array($result))
	{
		if(isset($_POST["btn"])){
		header("location:tresetpwd.php");}
	}
	else
	{
...
<body style="background-image: url('../images/bk.jpg'); background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
	...
	<div class="login" id="login" style="height: 800px;background-image: url(../images/tloginbk.png);">
	<form method="post" action="" >
		...
		<div class="user" id="user" style="position: absolute;left: 41%;top: 40%;">
			...
			<center>
				...
				<font size="4"><a href="TRegister.php" id="signin">Sign Up</a></font><br><br>
				<font size="4"><a href="tlogin.php" id="signin">Login</a></font>
			</center>
		</div>
	</form>
	</div>
