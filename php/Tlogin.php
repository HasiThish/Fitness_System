...
if(isset($_POST["uname"]))
{
	...
	$sql = "SELECT Username,TPassword FROM trainer WHERE Username = '$usname' AND TPassword = '$pssword'";
	$result = mysqli_query($conn,$sql);
	
	if($row=mysqli_fetch_array($result))
	{
		$_SESSION["Tusername"] = '$usname';
...
<body style="background-image: url('../images/bk.jpg'); background-repeat: no-repeat;background-attachment: fixed;background-size: cover;">
	...
	<div class="login" id="login" style="background-image: url(../images/tloginbk.png);">
	<form method="post" action="#">
		<center><font size="50px"  id="topic">Trainer Login</font></center>
		<div class="userpic">
		...
		<div class="user" id="user">
			...
			<a href=tforgetpwd.php target="_self"  id="link">
			...
			<center>
				...
				<font size="4"><a href="TRegister.php" id="signin">Sign Up</a></font>
			</center>
		</div>
	</form>
	</div>
